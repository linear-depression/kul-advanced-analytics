...
│   ├── downloader.py        # Download images + metadata
│   ├── evaluate.py          # F1-score evaluation & plots
│   ├── interpret.py         # Grad-CAM interpretability
│   ├── model.py             # ResNet18 model definition
│   └── train.py             # Training loop
├── data/                    # Downloaded images & minifigs.json (gitignored)
├── outputs/
│   ├── plots/               # Generated evaluation plots
│   └── saved_models/        # Trained model checkpoints
├── report/
│   └── proj2_report.tex     # LaTeX project report
...
## 4. Task Objective: "Choice B" (Multilabel Theme Prediction)
...
## 6. Methodology: Addressing Class Imbalance
...
## 8. Model Interpretability (Grad-CAM)
